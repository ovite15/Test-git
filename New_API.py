...
async def voice_to_text(file: UploadFile = File(...)):
    ...
    transcription = speech_to_text.transcribe(voice_data)
    analysis_result = speech_to_text.analyze(transcription['text'])
    return JSONResponse(content={"TEXT": analysis_result})
